    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2>মানি রিসিপ্ট(ডোনার) তথ্য</h2>
                <a href="<?php echo asset('/money_receipt_donar') ?>" class="btn btn-primary btn-xs" style="float:right;margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i>
                    নতুন যোগ করুন
                </a>
            </header>
                            ...
                            @foreach($cash_receipt_info as $singleData)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/delete_money_receipt_donar/'. $singleData->id  ) }}" onclick="return confirm('Are you want to delete this record')" title="Delete" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </a>
                                    </td>
