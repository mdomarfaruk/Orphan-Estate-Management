...
<head>
    ...
    <!---- kendo UI Css ---->
    {{--<link href="{{ asset('fontView') }}/kendo/styles/kendo.common.min.css" rel="stylesheet">--}}
    {{--<link href="{{ asset('fontView') }}/assets/kendo/styles/kendo.rtl.min.css" rel="stylesheet">--}}
    {{--<link href="{{ asset('fontView') }}/assets/kendo/styles/kendo.silver.min.css" rel="stylesheet">--}}
    {{--<link href="{{ asset('fontView') }}/assets/kendo/styles/kendo.mobile.all.min.css" rel="stylesheet">--}}
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('fontView') }}/assets/css/smartadmin-rtl.min.css">
    ...
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('fontView') }}/assets/img/splash/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('fontView') }}/assets/img/splash/touch-icon-ipad-retina.png">
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('fontView') }}/assets/img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
    <link rel="apple-touch-startup-image" href="{{ asset('fontView') }}/assets/img/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
    <link rel="apple-touch-startup-image" href="{{ asset('fontView') }}/assets/img/splash/iphone.png" media="screen and (max-device-width: 320px)">
    ...
    <!----angular js----->
    {{--<script src="{{ asset('fontView') }}/assets/js/js/library/angular.min.js"></script>--}}
    {{--<script src="{{ asset('fontView') }}/assets/js/js/library/angular.route.min.js"></script>--}}
    <!----angular js----->
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php  echo asset('/home');?>">ডেসবোর্ড</a> </li><li>@yield('title_area')</li>
        </ol>
    ...
    <div id="content">
        <div class="col-sm-12" style="height: 20px;font-size:15px;">
...
<!-- SmartChat UI : plugin -->
<script src="{{ asset('fontView') }}/assets/js/smart-chat-ui/smart.chat.ui.min.js"></script>
<script src="{{ asset('fontView') }}/assets/js/smart-chat-ui/smart.chat.manager.min.js"></script>
...
<script src="{{ asset('fontView') }}/assets/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="{{ asset('fontView') }}/assets/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- Full Calendar -->
<script src="{{ asset('fontView') }}/assets/js/plugin/moment/moment.min.js"></script>
<script src="{{ asset('fontView') }}/assets/js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script>

<!--jszip required for kendo export to excel feature-->
{{--<script src="{{ asset('fontView') }}/assets/kendo/js/jszip.min.js"></script>--}}
{{--<script src="{{ asset('fontView') }}/assets/kendo/js/kendo.all.min.js"></script>--}}

<!----angular js----->
{{--<script src="{{ asset('fontView') }}/assets/js/js/ng-app.js"></script>--}}
{{--<script src="{{ asset('fontView') }}/assets/js/js/controller/ng-controller.js"></script>--}}
<!----angular js----->
