                ...
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                            <?php $i=1; ?>
                            @foreach($userAccessInfo as $singleData)
                                <tr>
                                    <td>  {{ $i++  }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/user_role/delete_user_role/'. $singleData->id  ) }}" onclick="return confirm('Are you want to delete this record')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </a>
                                    </td>
                            ...
                            <tr>
                                <td colspan="2" style="padding-top:0px !important;padding-bottom:0px !important;border-right:1px solid #fff;">
                                    {{ $userAccessInfo->links() }}
                                </td>
                                <td colspan="2" style="text-align:right;">
                                    Showing {{ $userAccessInfo->firstItem() }}- {{ $userAccessInfo->lastItem() }} from {{ $userAccessInfo->count() }} Item
                                </td>
                            </tr>
                            </tfoot>
                        </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ইউজার এক্সেস  তথ্য</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                {!! Form::open(['url' => '/user_role/information', 'method' => 'post','class'=>'form-horizontal']) !!}
