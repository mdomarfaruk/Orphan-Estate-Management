...
@section('main_content_area')
        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
                <header>
                    ...
                    <h2>পেমেন্ট ব্যাংক এন্টি</h2>
                    <a href=" <?php  echo asset('/get_payment_bank');?>" class="btn btn-primary btn-xs" style="float:right;margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i> পেমেন্ট ব্যাংক তথ্য</a>
                ...
                <div>
                    <div class="widget-body no-padding">
                        <div class="col-sm-12">
                            ...
                            {!! Form::open(['url' => '/save_payment_bank', 'method' => 'post','class'=>'form-horizontal']) !!}
                                ...
                                <div class="row">
                                    <table class="table table-bordered" id="default_table">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width:150px;">গ্রহনকারী</th>
                                        ...
                                        <tr>
                                            <td>
                                                <select required  name="bank_id[]"  id="bank_id_1" class="form-control">
                                            ...
                                            <td><input type="text" placeholder="ভাউচার নং" id="vouchar_no_1" required name="vouchar_no[]" class="form-control"> </td>
                                            <td><input type="text" placeholder="গ্রহনকারী" id="payee_by_1" required name="payee_by[]" class="form-control"> </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="4" style="text-align:right;">মোট টাকার পরিমান</th>
    ...
    <script>
        ...
        $('#addRow').on('click', function () {
            $('<tr><td><select required  name="bank_id[]"  id="bank_id_'+i+'" class="form-control">\n' +
                '                                                    <option value="">চিহ্নিত করুন</option>\n' +
                '                                                    @if(!empty($bank_head_info))\n' +
                '                                                        @foreach ($bank_head_info as $key => $value)\n' +
                '                                                            <option value="{{ $key }}">{{ $value }}</option>\n' +
                '                                                        @endforeach\n' +
                '                                                    @endif\n' +
                '                                                </select></td><td><input type="text" placeholder="ভাউচার নং" id="vouchar_no_'+ i +'" required name="vouchar_no[]" class="form-control"></td><td><input type="text" placeholder="গ্রহনকারী" id="payee_by_'+i+'" required name="payee_by[]" class="form-control"> </td><td> <select required type="text" placeholder="খাত" name="chart_off_acc[]"  class="form-control">\n' +
                '                                                    <option value="">চিহ্নিত করুন</option>\n' +
                '                                                    @if(!empty($expense_head_info))\n' +
                '                                                        @foreach ($expense_head_info as $key => $value)\n' +
                '                                                            <option value="{{ $key }}">{{ $value }}</option>\n' +
