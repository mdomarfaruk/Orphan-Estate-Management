        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
                <header>
                    ...
                    <h2>ব্যাংক পেমেন্ট তথ্য</h2>
                    <a href="<?php echo asset('/payment_bank') ?>" class="btn btn-primary btn-xs" style="float:right;margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i>
                        নতুন যোগ করুন
                    </a>
                </header>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="col-sm-12">
                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                ...
                                <tbody>
                                <?php $i=1; ?>
                                @foreach($cash_payment_bank_info as $singleData)
                                    <tr>
                                        <td>  {{ $i++  }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/delete_payment_bank/'. $singleData->id  ) }}" onclick="return confirm('Are you want to delete this record')" title="Delete" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </a>
                                        </td>
                                ...
                                <tr>
                                    <td colspan="4" style="padding-top:0px !important;padding-bottom:0px !important;border-right:1px solid #fff;">
                                        {{ $cash_payment_bank_info->links() }}
                                    </td>
                                    <td colspan="2" style="text-align:right;">
                                        Showing {{ $cash_payment_bank_info->firstItem() }}- {{ $cash_payment_bank_info->lastItem() }} from {{ $cash_payment_bank_info->total() }} Item
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
